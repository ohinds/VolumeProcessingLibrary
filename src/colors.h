/*****************************************************************************
 * colors.h is the header file for the color defs for libvp
...
#define VPCOLORS_H "$Id: colors.h,v 1.3 2007/05/22 19:18:06 oph Exp $"

#ifndef VPCOLORS_H
#define VPCOLORS_H

const int NUMVPCOLORS = 12;
const int NUMTACKVPCOLORS = 5;
...
/********************************************************************
 * $Source: /home/cvs/PROJECTS/VolumeProcessingLibrary/src/colors.h,v $
 * Local Variables:
 * mode: C
 * fill-column: 76
 * comment-column: 0
